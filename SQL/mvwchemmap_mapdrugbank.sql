-- View: public.mvwchemmap_mapdrugbank

-- DROP MATERIALIZED VIEW public.mvwchemmap_mapdrugbank;

CREATE MATERIALIZED VIEW public.mvwchemmap_mapdrugbank
...
AS
 SELECT chem.drugbank_id,
   ...
   FROM chemical_description coo
     ...
     LEFT JOIN chem_prop_drugbank_value prop ON chem.drugbank_id = prop.source_id
...
ALTER TABLE public.mvwchemmap_mapdrugbank
    OWNER TO postgres;