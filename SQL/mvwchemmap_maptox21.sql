...
DROP MATERIALIZED VIEW mvwchemmap_maptox21;

CREATE MATERIALIZED VIEW mvwchemmap_maptox21
...
AS
 SELECT chem.dsstox_id,
   ...
   FROM chemical_description coo
     ...
     INNER JOIN c_hts_chemicalqc chts ON chts.dsstox_id = chem.dsstox_id
...
ALTER TABLE mvwchemmap_maptox21
    OWNER TO postgres;