...
PCAplot = function (din, path_result){
  ...
  png (paste (path_result, "/text.png", sep = ""), 1700, 1500)
  ...
  png (paste (path_result, "/color.png", sep = ""), 1700, 1500)
  factor = factorACP (data_plot, cp)
  ...
  png (paste (path_result, "/descriptor.png", sep = ""), 1700, 1500)
  par(mar=c(8,8,8,8))
  ...
  svg (file = paste (path_result, "/descriptor.svg", sep = ""), 25, 25)
  par(mar=c(8,8,8,8))
...
generateCoordCombinedPCA = function(d1D2D, d3D, prout){
  ...
  p_dir = paste(prout, "\\PCA_combinePlanDESC1D2D_DESC3D\\", sep = "")
  dir.create(p_dir)
  gifGeneration(p_dir, coordSpace)
